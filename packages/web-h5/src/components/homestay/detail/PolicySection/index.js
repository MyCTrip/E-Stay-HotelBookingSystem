 ...
 * PolicySection 内容组件
 */
const PolicySectionContent = ({ data, cancelMinutes = 30, checkInDate = '2026-02-21', checkInTime = '14:00', checkOutTime = '12:00', deadlineTime = 24, amenities = {
    baby: true,
    children: true,
    elderly: true,
    overseas: true,
...
const PolicySection = ({ room, data, cancelMinutes = 30, checkInDate = '2026-02-21', checkInTime = '14:00', checkOutTime = '12:00', deadlineTime = 24, amenities = {
    baby: true,
    children: true,
    elderly: true,
    overseas: true,
    ...
    return (_jsxs(_Fragment, { children: [_jsx(PropertyCardContainer, { headerConfig: {
                ...
                }, children: _jsx(PolicySectionContent, { data: data, cancelMinutes: cancelMinutes, checkInDate: checkInDate, checkInTime: checkInTime, checkOutTime: checkOutTime, deadlineTime: deadlineTime, amenities: amenities }) }), _jsx(RoomDetailDrawer, { room: isDrawerOpen ? policyRoom : null, isOpen: isDrawerOpen, onClose: handleCloseDrawer, scrollToPolicy: true, actualRoomName: roomName })] }));
};
