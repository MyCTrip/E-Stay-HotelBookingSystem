...
const RoomDrawerFeeNotice = ({ room, deposit = 500, standardGuests = 2, joinNumber = 2, joinPrice = 100, otherDescription = '', showOther = false, feeInfo: middlewareFeeInfo, }) => {
    // 使用中间件数据，如果有则优先使用
