    ...
    <>
      ...
      <div className={`${styles.drawer} ${visible ? styles.active : ''}`}>
        ...
        <div className={styles.header}>
          ...
          <h2 className={styles.title}>搜索位置</h2>
            ...
            searchResults.length > 0 ? (
              <div className={styles.resultsSection}>
                {searchResults.map((result) => (
                  ...
                  >
                    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" className={styles.resultIcon}>
              ...
              <div className={styles.historySection}>
                ...
                <div className={styles.historyList}>
                  {searchHistory.map((history) => (
                    ...
                    >
                      <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" className={styles.historyIcon}>
