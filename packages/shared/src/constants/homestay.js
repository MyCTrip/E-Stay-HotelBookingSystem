...
export const API_PATHS = {
    ...
    HOMESTAY_DETAIL: (id) => `/homestays/${id}`,
...
export const ROUTES = {
    ...
    HOTEL_DETAIL_HOMESTAY: (id) => `/hotel-detail/homestay/${id}`,
    ROOM_DETAIL_HOMESTAY: (hotelId, roomId) => `/room-detail/homestay/${hotelId}/${roomId}`,
};
