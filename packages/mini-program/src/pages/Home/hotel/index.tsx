      ...
      <View className={styles.container}>
        ...
        <View className={styles.banner}>
          <View className={styles.bannerContent}>
            <Text className={styles.bannerTitle}>发现您的下一个酒店</Text>
            <Text className={styles.bannerSubtitle}>在全球数百万家酒店中搜索</Text>
          </View>
        </View>
        ...
        <View className={styles.features}>
          <Text className={styles.featuresTitle}>为什么选择我们的酒店？</Text>
